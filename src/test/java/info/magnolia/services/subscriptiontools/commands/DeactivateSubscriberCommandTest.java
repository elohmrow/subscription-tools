 ...
 * TBD.
 */
public class DeactivateSubscriberCommandTest extends MgnlTestCase {

    private static final Logger logger = LoggerFactory.getLogger(GetPublicKeyCommandTest.class);

    ActivationManager activationManager;
    DeactivateSubscriberCommand command;
    ...
    public void setUp() throws Exception {
        ...
        command = new DeactivateSubscriberCommand(activationManager);
    }
    ...
    public void testSmoke() {
        ...
        assertNotNull("Expected a DeactivateSubscriberCommand instance", command);
    ...
    @Test
    public void testDeactivateSubscriberNoConfig() throws Exception {
        logger.debug("testDeactivateSubscriberNoConfig called");
        ...
        assertFalse("Expected active property of subscriber to be false", (Boolean) valueCapture.getValue());
        assertTrue("Expected active attribute in context", context.containsKey(ActivateSubscriberCommand.ACTIVE_KEY));
        assertFalse("Expected active attribute in context to be false", (Boolean) context.getAttribute(ActivateSubscriberCommand.ACTIVE_KEY));
    }
